...
const CustomFormEdit = () => {
    ...
    return (
        <div className="grid grid-cols-[300px_auto] rounded-lg m-auto mb-10 max-w-6xl">
            ...
            <form className="grid px-7 bg-white border rounded-md shadow-lg">
                ...
                {!itens.length && 
                    <p className="my-5 font-semibold text-lg text-gray-500">Click <a className="underline" href="/">here</a> to customise your form and store data</p>
                }
            </form>
        </div>
    )
